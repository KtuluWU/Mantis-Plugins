...
<table id="guide">
	...
	<tr>
		...
		<td><?php echo nl2br( plugin_lang_get('code_more') ) ?></td>
		<td><?php echo string_display_links(plugin_lang_get('code_more_re')) ?></td>
	</tr>

	<tr>
		<td class="category"></td>
		<td><?php echo nl2br( plugin_lang_get('code_more_more') ) ?></td>
		<td><?php echo string_display_links(plugin_lang_get('code_more_more_re')) ?></td>
	</tr>
