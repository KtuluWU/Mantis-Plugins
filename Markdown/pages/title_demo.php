...
<table id="guide">
	...
	<tr>
		<td class="category"><?php echo plugin_lang_get('nom_title_more')?></td>
		<td><?php echo nl2br( plugin_lang_get('title_more') ) ?></td>
		<td><?php echo string_display_links(plugin_lang_get('title_more')) ?></td>
	</tr>
