...
<table id="guide">
	<tr>
		<th colspan=3 class="title">
			<?php echo plugin_lang_get('list_order_nom') ?>
		</th>
	</tr>
	...
	<tr>
		<td class="category"><?php echo plugin_lang_get('list_order_desc') ?></td>
		<td><?php echo nl2br( plugin_lang_get('list_order_more') ) ?></td>
		<td><?php echo string_display_links(plugin_lang_get('list_order_more')) ?></td>
	</tr>
