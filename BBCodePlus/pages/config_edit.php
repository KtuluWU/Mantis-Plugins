...
$f_code_name_alias = gpc_get_string_array( 'code_name_alias', array( "c#" => "csharp" ) );
...
if( plugin_config_get( 'code_name_alias' ) != $f_code_name_alias ) {
	plugin_config_set( 'code_name_alias', $f_code_name_alias );
}
